...
public class MemberController {
	...
	/*
	@RequestMapping(value="/pwd_check_form", method=RequestMethod.GET)
	public String pwdCheckView(@RequestParam(value="pwd", defaultValue="", required=false) String pwd, Moedl model) {
		
		model.addAttribut("pwd",pwd);
	}
	*/
